...
def aplicacion(matriz_poke: list[list]):
    
    corriendo = True
    matriz_poke_t = mat.trasponer_matriz(matriz_poke)
    ...
    while corriendo:
        ...
        match opcion:
            ...
            case '5':
                ...
                mat.mostrar_pokemons_fuertes(matriz_poke_t)
                
            case '6':
                # mali.mostrar_porcentajes_condiciones(lista_c)
                mat.mostrar_pokemons_porcentaje(matriz_poke_t)
            case '7':
                corriendo = False
        os.system('pause')
        os.system('cls') # clear
